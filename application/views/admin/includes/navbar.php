...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?php if ($this->uri->segment('1') == 'addpegawai'){ echo('active'); } ?>">
      ...
      <li class="nav-item <?php if ($this->uri->segment('1') == 'subunit'){ echo('active'); } ?>">
      ...
      <li class="nav-item <?php if ((($this->uri->segment('1') == 'listpegawai')&&($this->uri->segment('2') != 'nonaktif')) || ($this->uri->segment('1') == 'kompetensi')){ echo('active'); } ?>">
      ...
      <li class="nav-item <?php if ($this->uri->segment('2') == 'nonaktif'){ echo('active'); } ?>">
