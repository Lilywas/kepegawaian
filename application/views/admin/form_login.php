						...
						<div class="row">
							<div class="col-lg">
								<div class="p-5">
									...
									<form class="user" action="<?php echo site_url('account/login'); ?>" autocomplete="on" method="POST" enctype="multipart/form-data" >
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="far fa-fw fa-user"></i></span>
											</div>
											<input type="text" class="form-control form-control-user" name="username"  placeholder="Masukkan Username" value="<?php echo set_value('username')?>" required>
