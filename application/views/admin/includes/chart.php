...
var data = {
  ...
  datasets: [{
    ...
    data: [
    <?php echo htmlspecialchars($jumlah_lk_pns);?>,
    <?php echo htmlspecialchars($jumlah_lk_nonpns);?>
    ]
  }, {
    label: 'Perempuan',
    backgroundColor: '#DC143C',
    data: [
    <?php echo htmlspecialchars($jumlah_pr_pns);?>, 
    <?php echo htmlspecialchars($jumlah_pr_nonpns);?>
    ]
  }]
};
...
var data = {
  ...
  datasets: [{
    ...
    data: [
    <?php echo htmlspecialchars($jumlah_sd_pns);?>,
    <?php echo htmlspecialchars($jumlah_smp_pns);?>,
    <?php echo htmlspecialchars($jumlah_smak_pns);?>,
    <?php echo htmlspecialchars($jumlah_d1_pns);?>,
    <?php echo htmlspecialchars($jumlah_d2_pns);?>,
    <?php echo htmlspecialchars($jumlah_d3_pns);?>,
    <?php echo htmlspecialchars($jumlah_d4_pns);?>,
    <?php echo htmlspecialchars($jumlah_s1_pns);?>,
    <?php echo htmlspecialchars($jumlah_s2_pns);?>,
    <?php echo htmlspecialchars($jumlah_s3_pns);?>
    ]
  }, {
    label: 'Non-PNS',
    backgroundColor: '#FF8C00',
    data: [
    <?php echo htmlspecialchars($jumlah_sd_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_smp_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_smak_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_d1_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_d2_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_d3_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_d4_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_s1_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_s2_nonpns);?>,
    <?php echo htmlspecialchars($jumlah_s3_nonpns);?>
    ]
  }]
};
...
var golpnschart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      data: [
      <?php echo htmlspecialchars($jumlah_1a_lk);?>,
      <?php echo htmlspecialchars($jumlah_1b_lk);?>,
      <?php echo htmlspecialchars($jumlah_1c_lk);?>,
      <?php echo htmlspecialchars($jumlah_1d_lk);?>,
      <?php echo htmlspecialchars($jumlah_2a_lk);?>,
      <?php echo htmlspecialchars($jumlah_2b_lk);?>,
      <?php echo htmlspecialchars($jumlah_2c_lk);?>,
      <?php echo htmlspecialchars($jumlah_2d_lk);?>,
      <?php echo htmlspecialchars($jumlah_3a_lk);?>,
      <?php echo htmlspecialchars($jumlah_3b_lk);?>,
      <?php echo htmlspecialchars($jumlah_3c_lk);?>,
      <?php echo htmlspecialchars($jumlah_3d_lk);?>,
      <?php echo htmlspecialchars($jumlah_4a_lk);?>,
      <?php echo htmlspecialchars($jumlah_4b_lk);?>,
      <?php echo htmlspecialchars($jumlah_4c_lk);?>,
      <?php echo htmlspecialchars($jumlah_4d_lk);?>,
      <?php echo htmlspecialchars($jumlah_4e_lk);?>],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    },{
      label : "Perempuan",
      backgroundColor: '#FFD700',
      data: [
      <?php echo htmlspecialchars($jumlah_1a_pr);?>,
      <?php echo htmlspecialchars($jumlah_1b_pr);?>,
      <?php echo htmlspecialchars($jumlah_1c_pr);?>,
      <?php echo htmlspecialchars($jumlah_1d_pr);?>,
      <?php echo htmlspecialchars($jumlah_2a_pr);?>,
      <?php echo htmlspecialchars($jumlah_2b_pr);?>,
      <?php echo htmlspecialchars($jumlah_2c_pr);?>,
      <?php echo htmlspecialchars($jumlah_2d_pr);?>,
      <?php echo htmlspecialchars($jumlah_3a_pr);?>,
      <?php echo htmlspecialchars($jumlah_3b_pr);?>,
      <?php echo htmlspecialchars($jumlah_3c_pr);?>,
      <?php echo htmlspecialchars($jumlah_3d_pr);?>,
      <?php echo htmlspecialchars($jumlah_4a_pr);?>,
      <?php echo htmlspecialchars($jumlah_4b_pr);?>,
      <?php echo htmlspecialchars($jumlah_4c_pr);?>,
      <?php echo htmlspecialchars($jumlah_4d_pr);?>,
      <?php echo htmlspecialchars($jumlah_4e_pr);?>],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],
  },
  options: {
