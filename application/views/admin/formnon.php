        ...
        <div class="card-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="date" class="form-control" name="tgl_lahir" value="<?= set_value('tgl_lahir') ?>" required="">
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <select class="form-control" name="pend">
                <option value="">----Pilih----</option>
                <option value="SD" <?= set_select('pend', 'SD'); ?>>SD</option>
                <option value="SMP" <?= set_select('pend', 'SMP'); ?>>SMP</option>
                <option value="SMA/K" <?= set_select('pend', 'SMA/K'); ?>>SMA/K</option>
                <option value="D1" <?= set_select('pend', 'D1'); ?>>D1</option>
                <option value="D2" <?= set_select('pend', 'D2'); ?>>D2</option>
                <option value="D3" <?= set_select('pend', 'D3'); ?>>D3</option>
                <option value="D4" <?= set_select('pend', 'D4'); ?>>D4</option>
                <option value="S1" <?= set_select('pend', 'S1'); ?>>S1</option>
                <option value="S2" <?= set_select('pend', 'S2'); ?>>S2</option>
                <option value="S3" <?= set_select('pend', 'S3'); ?>>S3</option>
              </select>
            </div>
            <div class="form-group col-md-4">
              <label>Jurusan</label>
              <input type="text" class="form-control" value="<?= set_value('jurusan') ?>" name="jurusan">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="hp" value="<?= set_value('hp') ?>" required="">
            </div>
            <div class="form-group col-md-4">
              <label>email</label>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <select class="form-control" name="bagian" required>
                <option value="">----Pilih----</option>
                <option <?= set_select('bagian', 'Administrasi'); ?>>Administrasi</option>
                <option <?= set_select('bagian', 'Front Office'); ?>>Front Office</option>
                <option <?= set_select('bagian', 'Petugas Kesehatan'); ?>>Petugas Kesehatan</option>
                <option <?= set_select('bagian', 'Driver'); ?>>Driver</option>
                <option <?= set_select('bagian', 'Kebersihan'); ?>>Kebersihan</option>
                <option <?= set_select('bagian', 'Keamanan'); ?>>Keamanan</option>
                <option <?= set_select('bagian', 'Petugas Lapangan'); ?>>Petugas Lapangan</option>
                <option <?= set_select('bagian', 'Petugas Teknik Listrik'); ?>>Petugas Teknik Listrik</option>
                <option <?= set_select('bagian', 'Petugas Teknik Audio Visual'); ?>>Petugas Teknik Audio Visual</option>
                <option <?= set_select('bagian', 'Lainnya'); ?>>Lainnya</option>
              </select>
            </div>
            <div class="form-group col-md-4">
              <label>Tanggal Mulai Kerja</label>
              <input type="date" class="form-control" name="tgl_kerja" value="<?= set_value('tgl_kerja') ?>">
            </div>
          </div>
        </div>
      </div>
